...
class RegexValidation {
  ...
  final RegExp kEmailValid = RegExp(
      r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+");
  final RegExp kPassValid =
...
class ValidateStr {
  ...
  static String skuLengthValidator =
      "Please enter the complete 20 character sku";
  static String otpLengthValidator = "Please enter the complete 4 digit otp";
  static String productNameLengthValidator =
      "Product name must be more than 5 character long";
  static String productSubtitleLengthValidator =
      "Product name must be more than 15 character long";
  ...
  static String passwordValidValidator =
      "Entered password should be minimum 8 character long";
